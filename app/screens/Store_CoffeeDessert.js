    ...
    const products = [
        {
            ...
            image: require('../assets/Images/coffee_am.png')
        },
        {
            id: 2,
            price: '15 pb',
            description: '스타벅스 카라멜 마키아또',
            image: require('../assets/Images/coffee_ca.png')
        },
        {
            id: 3,
            price: '13 pb',
            description: '스타벅스 카페 모카',
            image: require('../assets/Images/coffee_cm.png')
        },
        {
            id: 4,
            price: '20 pb',
            description: '아이스 스타벅스 돌체라떼 T',
            image: require('../assets/Images/ice_sample.png')
        },
        {
            id: 5,
            price: '17 pb',
            ...
            <View style={styles.productsSection}>
                {products.map((product) => (
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate('Store_CoffeeDessert_Detail', { product })}
                    >
...
export default Store_CoffeeDessert;
