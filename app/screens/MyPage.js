        ...
        backgroundColor={theme.color.white}/> */}
          ...
          <Text>Mypage!</Text>
            ...
            <ScrollView contentContainerStyle={styles.background}>
                <ProfileView navigation={navigation} name={nickname} imageUri={profileImage} Auth={auth} pb={pbBalance}
                             qty={qty}/>
                <MyPageBanner/>
                <View style={styles.lineHorizontal}/>
                ...
                <LogoutOverlay overlayVisible={logoutOverlayVisible} animatedHeight={animatedHeight}
                               closeModal={closeLogoutModal}/>
                <QuitOverlay overlayVisible={quitOverlayVisible} animatedHeight={animatedHeight}
                             closeModal={closeQuitModal} fetchDeleteGroup={fetchDeleteGroup}/>
            </ScrollView>
        </>
    );
}
